...
const app = express();
app.use(express.static(__dirname+"/upload"));//หากไม่ระบุบรรทัดนี้ โลกภายนอกจะไม่สามารถเข้าถึงโฟเดอร์ได้ | __dirname+"/upload" หมายถึงจะสามรถเข้าถึงได้เฉพาะภายใต้ dir upload เท่านั้น
